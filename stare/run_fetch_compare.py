...
summaries = wyniki / "summaries"; summaries.mkdir(exist_ok=True)
...
# -------- 3) STEMPEL CZASU W NAZWIE WYNIKU - TERAZ W FOLDERZE SUMMARIES --------
summary = summaries / "era5_comparison_summary.csv"  # ZMIANA: szukamy w summaries/
ts = datetime.now(timezone.utc).strftime("%Y%m%d_%H%M%SZ")
stamped = summaries / f"era5_comparison_summary_{ts}.csv"  # ZMIANA: zapisujemy w summaries/
